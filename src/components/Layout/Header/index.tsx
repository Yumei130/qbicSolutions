...
const Header: React.FC = () => {
  ...
  return (
    ...
    //     <div
    //       ref={mobileMenuRef}
    //       className={`fixed inset-0 z-50 bg-darkmode transition-transform duration-300 ease-in-out transform ${
    ...
    //           className="text-gray-700 hover:text-primary text-3xl"
    ...
    //         </button>
    //       </div>
    //       <nav className="flex flex-col p-4 space-y-4 overflow-y-auto h-[calc(100vh-60px)]">
    //         {headerData.map((item, index) => (
    //           <MobileHeaderLink
    //             key={index}
    //             item={item}
    ...
    >
      <div className="lg:py-0 py-2">
        <div className="w-full max-w-screen-xl mx-auto flex items-center justify-between px-4">
          ...
          <div className="flex items-center gap-4">
            {/* Aquí puedes incluir el código para botones o enlaces adicionales */}
            <button
              onClick={() => setNavbarOpen(!navbarOpen)}
              className="lg:hidden p-2 rounded-lg flex flex-col justify-center items-center me-14"
              aria-label="Toggle mobile menu"
            >
              <span className="block w-6 h-0.5 bg-white"></span>
              <span className="block w-6 h-0.5 bg-white mt-1.5"></span>
        ...
        >
          <div className="flex items-center justify-between p-4">
            ...
            <button
              onClick={() => setNavbarOpen(false)}
              className="text-gray-700 hover:text-primary text-3xl me-14"
              aria-label="Cerrar menú"
              type="button"
            >
              ✕
